...
class BarcodeScannerController {
  ...
  //gerencia de estado value notify
...
//PEGANDO A PRIMEIRA CAMERA DA LISTA E FORÇANDO A UTILIZAR A TRASEIRA
      cameraController = CameraController(
        camera,
        ResolutionPreset.max,
        enableAudio: false,
      );
      await cameraController!.initialize(); // ! significa não nullable
      scanWithCamera();
      listenCamera();
    } catch (e) {
